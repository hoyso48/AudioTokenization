...
from dtp.tome_ops import GeneralizedToMe, GeneralizedToMeMaskingUpsampler, ToMeGreedy, ToMeTopK
...
class CodecLightningModule(pl.LightningModule):
    ...
    def construct_model(self):
        ...
        self.tome = ToMeTopK(kernel_size=4, num_iterations=8, r=0.5)
        self.masking_upsampler = GeneralizedToMeMaskingUpsampler(enccfg.out_channels, kernel_size=4)
